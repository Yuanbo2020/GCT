...
def main(argv):
    ...
    model, conv_shape, base_model = using_model(frame_num, height, config.ctc_class)

    training(model_dir, sample_num, conv_shape, model, epoch=epochs, batch=config.batch_size)
