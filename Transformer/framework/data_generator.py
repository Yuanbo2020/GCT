...
class DataGenerator_Noiseme_2tokens(object):
    def __init__(self, start_end_labels=False, batch_size=config.batch_size, seed=9):
        ...
        print('Training samples: ', len(self.train_audio_indexes), '  validation samples: ', len(self.val_audio_indexes))
        ...
        if start_end_labels:
            ...
            # print(self.y_val)
            # [  20    1    0 ... 1001 1001 1001]
            #  [   0    2   29 ... 1001 1001 1001]
            #  [  19   18 1001 ... 1001 1001 1001]
            # [  23   20   23 ... 1001 1001 1001]
            #  [   0    0    0 ... 1001 1001 1001]
            #  [  20   21    0 ... 1001 1001 1001]


            # print(self.y)
            # [   0    1    0 ... 1001 1001 1001]
            #  [   0    1 1001 ... 1001 1001 1001]
            #  [   0    1    0 ... 1001 1001 1001]
            # [   7    7    7 ... 1001 1001 1001]
            #  [  32   21   21 ... 1001 1001 1001]
            #  [  20    0 1001 ... 1001 1001 1001]
    ...
    def label_set(self):
        ...
        # print('self.max_length: ', self.max_length)   # 22
    ...
    def generate_validate(self, data_type, max_iteration=None):
        ...
        while True:
            ...
            yield batch_x, np.array(batch_y_sequence), np.array(batch_y_len), batch_audio_names
